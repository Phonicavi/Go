...
typedef struct sbs {
	...
	*	legal_moves_num = 0 */
	 ...
	 *	x: pos = x
	 *  1: 不合法 0：合法
	 *  对于白棋棋盘上位置为x的地方是不是合法的 */
	/* 程序里多用 color - 1 i.e.legal[0][] 白棋相关 legal[1][] 黑棋相关 */
	...
	/*  用位数组表示的棋盘,维护棋盘状态，每次下子收子都会有变化
		13个 0000 0000 0000 0000 0000 0000 0000 0000
		EMPTY：00	WHITE：01	BLACK：10
		顺序是从右往左 */
	//bitboard board_bit[MAX_BOARD];//位数组不用了，不需要比较局面，没有意义，而且慢
